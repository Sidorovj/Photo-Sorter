...
{
    /// Записывать в лог: потр. время, сумм. объем файлов, 
    /// TODO: Распараллелить
    /// TODO: Оптимизировать на перехват исключений
    /// TODO: Настройка выбора расширений изображений
    /// TODO: !Сделать парсилку даты из названия 
    /// TOdO: Автонастройка ширины LabelSelectedPath_SizeChanged
    /// 
    /// <summary>
    /// 
    /// </summary>
